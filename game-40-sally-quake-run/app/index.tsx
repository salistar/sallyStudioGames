...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Physique / Équilibre</Text>
      
      {highScore > 0 && (
        <View style={styles.recordBox}>
          <Text style={styles.recordLabel}>MEILLEUR TEMPS</Text>
          <Text style={styles.recordValue}>{highScore}s</Text>
        </View>
      )}
      ...
      >
        <Text style={styles.btnText}>Tenir bon</Text>
      </Pressable>
    </View>
  );
}

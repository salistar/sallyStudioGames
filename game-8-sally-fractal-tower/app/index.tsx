...
export default function HomeScreen() {
  ...
  return (
    <View style={{ flex:1, backgroundColor: CONFIG.COLORS.background, alignItems:'center', justifyContent:'center', gap:20 }}>
      <Text style={{ color: CONFIG.COLORS.text, fontSize:42, fontWeight:'800' }}>Sally's Fractal Tower</Text>
      <Text style={{ color: CONFIG.COLORS.muted, fontSize:14 }}>timing/stacking</Text>

...
export default function ResultsScreen() {
  ...
  return (
    <View style={{ flex:1, backgroundColor: CONFIG.COLORS.background, alignItems:'center', justifyContent:'center', gap:20 }}>
      <Text style={{ color: CONFIG.COLORS.primary, fontSize:24, fontWeight: 'bold' }}>Tour Terminée !</Text>
      <Text style={{ color: CONFIG.COLORS.text, fontSize:72, fontWeight:'800' }}>{score}</Text>
      <Text style={{ color: CONFIG.COLORS.muted }}>Sally adore votre sens de l'équilibre !</Text>
      <Pressable

...
export default function HomeScreen() {
  ...
  return (
    <View style={{ flex:1, backgroundColor: CONFIG.COLORS.background, alignItems:'center', justifyContent:'center', gap:20 }}>
      <Text style={{ color: CONFIG.COLORS.text, fontSize:42, fontWeight:'800' }}>Sally's Souk Trader</Text>
      <Text style={{ color: CONFIG.COLORS.muted, fontSize:14 }}>simulation/gestion</Text>
      {highScore > 0 && <Text style={{ color: CONFIG.COLORS.warning, fontSize:22 }}>Record: {highScore} DH</Text>}
      <Pressable

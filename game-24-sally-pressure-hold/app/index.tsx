...
export default function HomeScreen() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Pressure Hold</Text>
      <Text style={styles.sub}>Ressens le temps parfait</Text>
...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: '#00FFCC', paddingHorizontal: 50, paddingVertical: 18, borderRadius: 30 },

...
export default function ResultsScreen() {
  ...
  return (
    <View style={{ flex:1, backgroundColor: CONFIG.COLORS.background, alignItems:'center', justifyContent:'center', gap:20 }}>
      <Text style={{ color: CONFIG.COLORS.primary, fontSize:24, fontWeight: 'bold' }}>Sally a adoré votre histoire !</Text>
      ...
      >
        <Text style={{ color:'#fff', fontWeight:'700', fontSize:16 }}>Nouvelle Histoire</Text>
      </Pressable>
